...
function make_table_pagination(ajax_url, ajax_data, table_div_id, data_per_page, search_enable_or_desiable, input_value, type, reload) {
    ...
    var manage_html = {
        ...
        make_new_table: function(current_page_new) {
            ...
            if (search_enable_or_desiable) {} else {
